...
const notifyData = [
  ...
  {
    image: notifyImage2,
    title: 'Ku***ro hizo su primer giro y ganó 1,025,430 ARS en Chicken VS Zimbies',
    text: '¡Haz tu primer giro tú también!'
  },
  {
    image: notifyImage3,
    title: '¡Da***ia ganó hoy 7,530,432 ARS en Chicken Road!',
    text: 'Prueba tu suerte'
  },
  {
    image: notifyImage4,
    title: '¡Ma****10 se ganó el de 5,348,090 ARS en Chicken VS Zimbie Up!',
    text: '¡Probá, divertite y ganá vos!'
  },
  {
    image: notifyImage5,
    title: '¡An***ta ganó 3,560,341 ARS en Chicken Road nada más registrarse!',
